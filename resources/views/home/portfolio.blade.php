            ...
            <div class="row mt-4">
                <div class="col-md-12 d-flex justify-content-center">
                    <ul class="list-unstyled d-flex portfolio-filters">
                        ...
                        <li data-filter=".filter-chair" class="py-2 px-4">Chair</li>
                        <li data-filter=".filter-table" class="py-2 px-4">Table</li>
                        <li data-filter=".filter-other" class="py-2 px-4">Other</li>
                    </ul>
                </div>
            </div>
